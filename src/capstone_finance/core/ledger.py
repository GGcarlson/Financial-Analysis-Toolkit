...
class CashFlowLedger:
    ...
    def __init__(
        ...
        tax_engine: Optional[Callable[[float, float], float]] = None
    ):
    ...
    def run(self, years: int, paths: int) -> list[list[YearState]]:
        ...
        for path_idx in range(paths):
            ...
            for year_idx in range(years):
                ...
                if hasattr(self.strategy, '_needs_full_state') and self.strategy._needs_full_state:
                    ...
                    withdrawal = self.strategy.calculate_withdrawal(current_state, self.params)
                else:
