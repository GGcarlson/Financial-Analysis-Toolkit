...
class TestCashFlowLedger:
    ...
    def test_hand_calculated_three_years(self):
        ...
        assert abs(path[1].balance - expected_year2) < 1.0  # Allow $1 tolerance for floating point
        ...
        assert abs(path[2].balance - expected_year3) < 1.0  # Allow $1 tolerance for floating point
    ...
    def test_tax_engine_integration(self):
        ...
        ledger_with_tax = CashFlowLedger(simulator, strategy, params, tax_engine=simple_tax)
